...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy.setHeightForWidth(page_startScreen->sizePolicy().hasHeightForWidth());
        page_startScreen->setSizePolicy(sizePolicy);
        ...
        label_x->setMinimumSize(QSize(10, 0));
        ...
        line_numberOfBoardsUp = new QFrame(page_freeFormSetup);
        line_numberOfBoardsUp->setObjectName(QString::fromUtf8("line_numberOfBoardsUp"));
        line_numberOfBoardsUp->setMinimumSize(QSize(0, 12));
        line_numberOfBoardsUp->setFrameShadow(QFrame::Plain);
        line_numberOfBoardsUp->setFrameShape(QFrame::HLine);

        gridLayout_setupSettings->addWidget(line_numberOfBoardsUp, 11, 1, 1, 4);
        ...
        gridLayout_3->addLayout(gridLayout_setupSettings, 7, 0, 1, 2);

        verticalSpacer_freeFormSetupDown = new QSpacerItem(0, 14, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_3->addItem(verticalSpacer_freeFormSetupDown, 11, 0, 1, 2);
